...
export function TournamentMenuButton() {
    return (
        <Menu menuButton={
            ...
            <MenuItem className="rounded-md px-3 py-1 hover:text-white hover:bg-black select-none">Bearbeiten</MenuItem>
            <MenuItem className="rounded-md px-3 py-1 hover:text-white hover:bg-black select-none">Löschen</MenuItem>
        </Menu>
    )
}